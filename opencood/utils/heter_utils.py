...
def assign_modality_4(
    root_dir="dataset/OPV2V",
    output_path="opencood/logs/heter_modality_assign/opv2v_4modality.json",
):
    np.random.seed(303)
...
def assign_modality_4_in_order(
    root_dir="dataset/OPV2V",
    output_path="opencood/heter_modality_assign/opv2v_4modality_in_order.json",
):
    """
...
if __name__ == "__main__":
    ...
    assign_modality_4(
        "dataset/V2XSET",
        output_path="opencood/logs/heter_modality_assign/v2xset_4modality.json",
    )
