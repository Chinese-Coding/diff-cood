...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        help=(
            ...
            " checkpoint can also be used for inference.Using a checkpoint for inference requires separate loading of the"
            " original pipeline and the individual checkpointed model components.See"
    ...
    parser.add_argument(
        ...
        default=1,
        help=(
            "Flag indicating if we are preconditioning the model outputs or not as done in EDM. This affects how "
    ...
    parser.add_argument("--dataset_preprocess_batch_size", type=int, default=1000, help="Batch size for preprocessing dataset.")
    parser.add_argument(
        "--validation_prompt",
        type=str,
        default=None,
    ...
    if args.resolution % 8 != 0:
        raise ValueError(
            "`--resolution` must be divisible by 8 for consistently sized encoded images between the VAE and the controlnet"
            " encoder."
        )
