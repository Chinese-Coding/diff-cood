...
class DptProcessor(BaseProcessor):
    ...
    @torch.no_grad()
    def prepare(self, dpt: torch.Tensor, inputs_ids: torch.Tensor):
        ...
        return noise, noisy_latents, timestep, encoder_hidden_states, down_block_res_samples, mid_block_res_sample
