...
def main(args):
    ...
    dpt_accelerator, dpt_processor, dpt_optimizer, dpt_lr_scheduler = init_modules(
        args, DptProcessor, optimizer_class, accelerator_project_config
    )
            ...
            if img_accelerator.sync_gradients and dpt_accelerator.sync_gradients:
                ...
                if img_accelerator.is_main_process and dpt_accelerator.is_main_process:
                    if global_step % args.checkpointing_steps == 0:
                        ...
                        save_checkpoint(args.output_dir, dpt_accelerator, global_step, "dpt")
